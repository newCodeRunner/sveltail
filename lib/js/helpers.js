...
export default () => ({
  ...
  getTextHeight(size, defaultVal) {
    let heightClass = '';

    let calcSize = size;
    if (defaultVal) calcSize = this.isAllowedSize(size) ? size : defaultVal;

    if (calcSize === 'xs') heightClass += 'h-4 ';
    else if (calcSize === 'sm') heightClass += 'h-5 ';
    else if (calcSize === 'md') heightClass += 'h-6 ';
    else if (calcSize === 'lg') heightClass += 'h-10 ';
    else if (calcSize === 'xl') heightClass += 'h-16 ';
    else if (calcSize === 'auto') heightClass += '';
  ...
  getTextWidth(size, defaultVal) {
    let widthClass = '';

    let calcSize = size;
    if (defaultVal) calcSize = this.isAllowedSize(size) ? size : defaultVal;

    if (calcSize === 'xs') widthClass += 'w-4 ';
    else if (calcSize === 'sm') widthClass += 'w-5 ';
    else if (calcSize === 'md') widthClass += 'w-6 ';
    else if (calcSize === 'lg') widthClass += 'w-10 ';
    else if (calcSize === 'xl') widthClass += 'w-16 ';
    else if (calcSize === 'auto') widthClass += '';
  ...
  getTextSize(size, defaultVal) {
    ...
    else if (calcSize === 'md') textClass += 'text-md leading-none ';
    else if (calcSize === 'lg') textClass += 'text-lg leading-none ';
    else if (calcSize === 'xl') textClass += 'text-2xl leading-none ';
  ...
  getFontSize(size, defaultVal) {
    ...
    else if (calcSize === 'sm') fontSize = 18;
    else if (calcSize === 'md') fontSize = 22;
    else if (calcSize === 'lg') fontSize = 28;
    else if (calcSize === 'xl') fontSize = 36;
