...
export default () => ({
  ...
  isAllowedColor: (value) => Object.keys(colors).findIndex((i) => i.split('-')[0] === value) > -1,
  ...
  getFontSize(size) {
    ...
    if (size === 'xs') fontSize = 16;
    else if (size === 'sm') fontSize = 24;
    else if (size === 'md') fontSize = 32;
    else if (size === 'lg') fontSize = 48;
    else if (size === 'xl') fontSize = 80;
